...
{
    public class OracleQueryFactory : BlueCat.ORM.SqlQueryFactory
    {
        public OracleQueryFactory()
            : base('"', '"', ':', '%', '_', OracleClientFactory.Instance)
        {
        }

        public OracleQueryFactory(System.Data.Common.DbProviderFactory fac)
            : base('"', '"', ':', '%', '_', fac)
        {
        }
