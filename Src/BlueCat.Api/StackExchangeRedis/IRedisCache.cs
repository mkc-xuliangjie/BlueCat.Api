...
namespace StackExchangeRedis
{
    ...
    public interface IRedisCache
    {
        ...
        /// <returns></returns>
        bool Set<T>(string key, T t, int seconds = 0) where T : class, new();
        /// <summary>
        /// 设置指定key的值，过期时间，若key存在则是修改，否则新增
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="seconds">过期时间</param>
        /// <returns></returns>
        Task<bool> SetAsync<T>(string key, T t, int seconds = 0) where T : class, new();
        /// <summary>
        /// 保存多个key- value，若key存在则是修改，否则新增
        /// </summary>
        /// <param name="kvs">键值对</param>
        /// <returns></returns>
        bool Set(IDictionary<string, string> kvs);
        /// <summary>
        /// 保存多个key- value，若key存在则是修改，否则新增
        /// </summary>
        /// <param name="kvs">键值对</param>
        /// <returns></returns>
        Task<bool> SetAsync(IDictionary<string, string> kvs);
        ...
        /// <param name="seconds">过期时间</param>
        /// <returns></returns>
        bool Add<T>(string key, T t, int seconds = 0) where T : class, new();
        /// <summary>
        /// 添加指定key的值，过期时间，若key不存在则新增，否则不会执行新增和修改
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="kvs">键值对</param>
        /// <returns></returns>
        bool Add(IDictionary<string, string> kvs);
        /// <summary>
        /// 异步保存多个key- value，若key不存在则新增，否则不会执行新增和修改
        /// </summary>
        /// <param name="kvs">键值对</param>
        /// <returns></returns>
        Task<bool> AddAsync(IDictionary<string, string> kvs);
        ...
        /// <param name="value">值</param>
        /// <returns></returns>
        Task<bool> HashSetAsync(string hashId, string key, string value);
        /// <summary>
        /// 存储对象T t到hash集合中
        /// </summary>
        ...
        void HashSet<T>(string key, T entity) where T : class, new();
        /// <summary>
        /// 存储对象T t到hash集合中
        /// </summary>
        /// <typeparam name="T">对象</typeparam>
        /// <param name="key">key</param>
        /// <param name="entity">对象</param>
        void HashSet<T>(string key, Expression<Func<T>> expression) where T : class, new();
        ...
        /// <param name="value">值</param>
        /// <returns></returns>
        Task<long> HashIncrementAsync(string hashId, string key, long value = 1);
        ...
        /// <param name="value">值</param>
        /// <returns></returns>
        long HashDecrement(string hashId, string key, long value = 1);
        /// <summary>
        ///  给hashid数据集key的value减去自减量，返回相加后的数据
        /// </summary>
        /// <param name="hashId">hashId</param>
        ...
        /// <param name="value">值</param>
        /// <returns></returns>
        Task<long> HashDecrementAsync(string hashId, string key, long value = 1);
        ...
        /// <param name="keys">keys</param>
        /// <returns></returns>
        Task<long> HashDeleteAsync(string hashId, string[] keys);
        ...
        /// <param name="key">key</param>
        /// <returns></returns>
        Task<RedisValue> HashGetAsync(string hashId, string key);
        ...
        /// <param name="hashId">hashId</param>
        /// <returns></returns>
        KeyValuePair<string, string>[] HashGetAll(string hashId);
        /// <summary>
        /// 获取所有hashid数据集的key/value数据集合
        /// </summary>
        /// <param name="hashId">hashId</param>
        /// <returns></returns>
         Task<KeyValuePair<string, string>[]> HashGetAllAsync(string hashId);
        ...
        /// <returns></returns>
        string[] HashKeys(string hashId);
        /// <summary>
        /// 获取hashid数据集中所有key的集合
        /// </summary>
        /// <param name="hashId"></param>
        /// <returns></returns>
        Task<string[]> HashKeysAsync(string hashId);
        ...
        /// <param name="hashId"></param>
        /// <returns></returns>
        string[] HashValues(string hashId);
        /// <summary>
        /// 获取hashid数据集中的所有value集合
        /// </summary>
        /// <param name="hashId"></param>
        /// <returns></returns>
         Task<string[]> HashValuesAsync(string hashId);
        ...
        /// <param name="hashId">hashId</param>
        /// <returns></returns>
        long HashLength(string hashId);
        /// <summary>
        /// 获取hashid数据集中的数据总数
        /// </summary>
        /// <param name="hashId">hashId</param>
        /// <returns></returns>
        Task<long> HashLengthAsync(string hashId);
        ...
        /// <returns></returns>
        string[] SetScan(string key, string pattern = null, int pageSize = 0, long cursor = 0, int pageOffset = 0);
        ...
        /// <returns></returns>
        long SortedSetAdd(string key, IDictionary<string, double> members);
        /// <summary>
        /// 将具有指定分数的所有指定成员添加到存储在键处的排序集。如果指定的成员已经是排序集的成员，则分数更新并在正确位置重新插入元件，以确保正确排序。
        /// </summary>
        /// <param name="key">key</param>
        /// <param name="members">成员集合</param>
        /// <returns></returns>
        Task<long> SortedSetAddAsync(string key, IDictionary<string, double> members);
        ...
        /// <returns></returns>
        long SortedSetCombineAndStore(RedisSetOperation operation, string desctination, string first, string second, RedisAggregate aggregate = RedisAggregate.Sum);
        /// <summary>
        /// 对两个排序集计算集合操作，并将结果存储在desctination中，可以选择执行特定聚合（默认值为SUM）。
        /// </summary>
        /// <param name="operation">操作类型</param>
        ...
        /// <param name="aggregate">特定聚合（默认值为SUM）</param>
        /// <returns></returns>
        Task<long> SortedSetCombineAndStoreAsync(RedisSetOperation operation, string desctination, string first, string second, RedisAggregate aggregate = RedisAggregate.Sum);
        /// <summary>
        ...
        /// <param name="aggregate">特定聚合（默认值为SUM）</param>
        /// <returns></returns>
        long SortedSetCombineAndStore(RedisSetOperation operation, string desctination, string[] keys, double[] weights = null, RedisAggregate aggregate = RedisAggregate.Sum);
        /// <summary>
        /// 对多个排序集计算集合操作，并将结果存储在desctination中，可以选择执行特定聚合（默认值为SUM）。
        /// </summary>
        /// <param name="operation">操作类型</param>
        ...
        /// <param name="aggregate">特定聚合（默认值为SUM）</param>
        /// <returns></returns>
        Task<long> SortedSetCombineAndStoreAsync(RedisSetOperation operation, string desctination, string[] keys, double[] weights = null, RedisAggregate aggregate = RedisAggregate.Sum);
        #endregion
        ...
        /// <returns></returns>
        long SortedSetLength(string key, double min = double.NegativeInfinity, double max = double.PositiveInfinity, RedisExclude exclude = RedisExclude.None);
        /// <summary>
        /// 返回有序集中指定分数区间内的成员
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="exclude">是否从范围检查中排除最小值和最大值（默认为包含这两个值）</param>
        /// <returns></returns>
        Task<long> SortedSetLengthAsync(string key, double min = double.NegativeInfinity, double max = double.PositiveInfinity, RedisExclude exclude = RedisExclude.None);
        ...
        /// <param name="exclude">是否从范围检查中排除最小值和最大值（默认为包含这两个值）</param>
        /// <returns></returns>
        long SortedSetLengthByValue(string key, string min, string max, RedisExclude exclude = RedisExclude.None);
        /// <summary>
        /// 返回有序集中指定分数区间内的成员个数
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="exclude">是否从范围检查中排除最小值和最大值（默认为包含这两个值）</param>
        /// <returns></returns>
        Task<long> SortedSetLengthByValueAsync(string key, string min, string max, RedisExclude exclude = RedisExclude.None);
        ...
        /// <returns></returns>
        string[] SortedSetRangeByRank(string key, long start = 0, long stop = -1, RedisOrder order = RedisOrder.Ascending);
        /// <summary>
        ...
        /// <param name="order">排序正序或倒序（默认正序）</param>
        /// <returns></returns>
         Task<string[]> SortedSetRangeByRankAsync(string key, long start = 0, long stop = -1, RedisOrder order = RedisOrder.Ascending);
        ...
        /// <param name="order">排序正序或倒序（默认正序）</param>
        /// <returns></returns>
        KeyValuePair<string, double>[] SortedSetRangeByRankWithScores(string key, long start = 0, long stop = -1, RedisOrder order = RedisOrder.Ascending);
        /// <summary>
        /// 返回有序集中指定区间内的成员和分数，通过索引
        /// </summary> 
        /// <param name="key">key</param>
        ...
        /// <param name="order">排序正序或倒序（默认正序）</param>
        /// <returns></returns>
        Task<KeyValuePair<string, double>[]> SortedSetRangeByRankWithScoresAsync(string key, long start = 0, long stop = -1, RedisOrder order = RedisOrder.Ascending);
        ...
        /// <returns></returns>
        string[] SortedSetRangeByScore(string key, double start = double.NegativeInfinity, double stop = double.PositiveInfinity, RedisExclude exclude = RedisExclude.None, RedisOrder order = RedisOrder.Ascending, long skip = 0, long take = -1);
        /// <summary>
        /// 返回有序集中指定区间内的成员，通过索引
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="take">显示多少条</param>
        /// <returns></returns>
        Task<string[]> SortedSetRangeByScoreAsync(string key, double start = double.NegativeInfinity, double stop = double.PositiveInfinity, RedisExclude exclude = RedisExclude.None, RedisOrder order = RedisOrder.Ascending, long skip = 0, long take = -1);
        #endregion
        ...
        /// <param name="take">显示多少条</param>
        /// <returns></returns>
        KeyValuePair<string, double>[] SortedSetRangeByScoreWithScores(string key, double start = double.NegativeInfinity, double stop = double.PositiveInfinity, RedisExclude exclude = RedisExclude.None, RedisOrder order = RedisOrder.Ascending, long skip = 0, long take = -1);
        /// <summary>
        /// 返回有序集中指定区间内的成员和分数，通过索引
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="take">显示多少条</param>
        /// <returns></returns>
         Task<KeyValuePair<string, double>[]> SortedSetRangeByScoreWithScoresAsync(string key, double start = double.NegativeInfinity, double stop = double.PositiveInfinity, RedisExclude exclude = RedisExclude.None, RedisOrder order = RedisOrder.Ascending, long skip = 0, long take = -1);
        ...
        string[] SortedSetRangeByValue(string key, string min = null, string max = null, RedisExclude exclude = RedisExclude.None, long skip = 0, long take = -1);
        /// <summary>
        /// 返回有序集中指定分数区间内的成员
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="take">显示多少条</param>
        /// <returns></returns>
        Task<string[]> SortedSetRangeByValueAsync(string key, string min = null, string max = null, RedisExclude exclude = RedisExclude.None, long skip = 0, long take = -1);
        ...
        /// <returns></returns>
        long? SortedSetRank(string key, string member, RedisOrder order = RedisOrder.Ascending);
        /// <summary>
        /// 返回存储在键上的已排序集中成员的排名，默认情况下，分数从低到高排序。排名（或指数）以0为基础，这意味着得分最低的成员的排名为0。
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="order">排序顺序（默认正序）</param>
        /// <returns></returns>
        Task<long?> SortedSetRankAsync(string key, string member, RedisOrder order = RedisOrder.Ascending);
        ...
        /// <param name="exclude">是否从范围检查中排除最小值和最大值（默认为包含这两个值）</param>
        /// <returns></returns>
        long SortedSetRemoveRangeByScore(string key, double start, double stop, RedisExclude exclude = RedisExclude.None);
        /// <summary>
        /// 删除存储在键处的排序集中的所有元素，其排名介于开始和停止之间。
        /// 开始和停止都是基于0的索引，0是得分最低的元素。
        /// 这些指数可以是负数，表示从得分最高的元素开始的偏移量。
        ...
        Task<long> SortedSetRemoveRangeByScoreAsync(string key, double start, double stop, RedisExclude exclude = RedisExclude.None);
        ...
        /// <param name="exclude">是否从范围检查中排除最小值和最大值（默认为包含这两个值）</param>
        /// <returns></returns>
        long SortedSetRemoveRangeByValue(string key, string min, string max, RedisExclude exclude = RedisExclude.None);
        /// <summary>
        /// 删除此排序区间的元素
        /// </summary>
        /// <param name="key">key</param>
        ...
        /// <param name="exclude">是否从范围检查中排除最小值和最大值（默认为包含这两个值）</param>
        /// <returns></returns>
        Task<long> SortedSetRemoveRangeByValueAsync(string key, string min, string max, RedisExclude exclude = RedisExclude.None);
        ...
        /// </summary>
        /// <param name="key"></param>
        void ScriptEvaluateDelete(string key);
