...
namespace System.Linq
{
    ...
    public static class EnumerableHelper
    {
        ...
        public static string AddFormat(this IList<string> em, string fmt, params object[] args)
        {
            if (fmt == null)
                return null;
            string str = args == null ? fmt : string.Format(fmt, args);
            if (em == null)
            {
                return str;
            }
        ...
        public static List<T> ParseToList<T>(this IEnumerable<string> source, Func<string, T> parse)
        {
            ...
            List<T> entityList = source as List<T>;
            if (entityList != null)
            {
                return entityList;
            }
        ...
        public static string LinkToSql(this IEnumerable<string> em, string empty = " ", char sp = ',', int maxCol = 5)
        {
            ...
            if (maxCol > 0)
            {
                int col = 0;
                int maxLen = 0;
                List<KeyValuePair<int, string>> ll = new List<KeyValuePair<int, string>>();
        ...
        public static string ListToString(this IEnumerable em, string fmString, string sp = ",", string head = null, string food = null)
        {
            ...
            if (em != null)
            {
                ...
                bool first = true;
                foreach (object o in from object o in em where o != null select o)
                {
                    if (first)
                    {
                        first = false;
        ...
        {
            Dictionary<string, TValue> re = new Dictionary<string, TValue>(StringComparer.OrdinalIgnoreCase);
