...
namespace BlueCat.Extensions
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return BlueCat.Extensions.Helpers.Enum.GetValue(instance.GetType(), instance);
        }
        ...
        {
            return BlueCat.Extensions.Helpers.Convert.To<TResult>(Value(instance));
        }
        ...
        {
            return BlueCat.Extensions.Helpers.Enum.GetDescription(instance.GetType(), instance);
        }
        ...
        {
            return BlueCat.Extensions.Helpers.String.Join(list, quotes, separator);
        }
    }
}
