...
namespace BlueCat.Extensions.Webs.Clients
{
    /// <summary>
    /// Http请求
    /// </summary>
    public class HttpRequest : HttpRequestBase<IHttpRequest>, IHttpRequest
    {
        ...
        {
            return BlueCat.Extensions.Helpers.Json.ToObject<T>(Result());
        }
        ...
        {
            return BlueCat.Extensions.Helpers.Json.ToObject<T>(await ResultAsync());
        }
    }
    ...
    public class HttpRequest<TResult> : HttpRequestBase<IHttpRequest<TResult>>, IHttpRequest<TResult> where TResult : class
    {
        ...
        private TResult ConvertTo(string result, string contentType)
        {
            if (typeof(TResult) == typeof(string))
                return BlueCat.Extensions.Helpers.Convert.To<TResult>(result);
        ...
        {
            return BlueCat.Extensions.Helpers.Json.ToObject<TResult>(Result());
        }
        ...
        {
            return BlueCat.Extensions.Helpers.Json.ToObject<TResult>(await ResultAsync());
        }
    }
}
